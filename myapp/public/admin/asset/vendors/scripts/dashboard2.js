$(document).ready(function() {
    ...
    $({ animatedVal: 0 }).animate({ animatedVal: $totalEarnings }, {
        duration: 5000,
        easing: "swing",
        step: function () {
    ...
    $({ animatedVal: 0 }).animate({ animatedVal:  $totalOrders  }, {
        duration: 3000,
        easing: "swing",
        step: function () {
    ...
    $({ animatedVal: 0 }).animate({ animatedVal:  $pendingOrders }, {
        duration: 3000,
        easing: "swing",
        step: function () {
    ...
    $({ animatedVal: 0 }).animate({ animatedVal:  $completedOrders }, {
        duration: 3000,
        easing: "swing",
        step: function () {
